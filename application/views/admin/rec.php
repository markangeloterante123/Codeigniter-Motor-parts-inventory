   ...
   $(document).ready(function () {
    ...
    $('.title_button').on('click','.back_category',function (){
      ...
      $('.item_category').on('click','.list_item',function (){
        ...
        table();
        var button = 
        '<a href="javascript:void(0)"  class="btn btn-info back_category" title="Back to Category"><i class="fa fa-times"></i> '+name+'</a> <input type="hidden"  name="id_category_search" value="'+id+'">';
        $('.title_button').html(button);
        display_item();
      });
          ...
          success: function (data) {
            ...
            var i;
              for(i=0; i < data.length; i++){ 
                if(data[i].qty == '0'){
                     html +=
                      '<tr>'+
                        ...
                        '<td>₱'+data[i].price+'</td>'+
                        '<td>'+
                        '<a href="<?php echo base_url(); ?>pages/pageAdmin_data2/individual_report2/'+data[i].id+'" target="_blank" class="btn btn-default"><i class="fa fa-folder-open" title="VIEW RECORDS"></i></a> '+
                ...
                if(data.length == '0'){
                 var button = 
                    '<a href="javascript:void(0)"  class="btn btn-info back_category" title="Back to Category"><i class="fa fa-arrow-left"></i> BACK</a> <input type="hidden"  name="id_category_search" value="'+id+'"> <a href="javascript:void(0)" data-id="'+id+'" class="btn btn-danger delete_category"><i class="fa fa-times"></i> REMOVE CATEGORY</a>';
                    $('.title_button').html(button);
                }
