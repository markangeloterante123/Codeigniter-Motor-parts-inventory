   ...
   $(document).ready(function () {
      ...
      function view_orders_display(){
                ...
                var id = $("input[name='user']").val();
                  $.ajax({
                    ...
                    success: function (data) {
                      ...
                      if(data.length >= '1'){
                        html +=
                          '<tr><td colspan="3"><a href="javascript:void(0)" class="btn btn-success process_pos"><i class="fa fa-check"></i> Process POS</a></td></tr>';
                      }   
       ...
       $('.process_table').on('click','.process_pos',function (){
         table2();
         var button = 
        '<a href="javascript:void(0)"  class="btn btn-success back_category" title="Back to Category"><i class="fa fa-arrow-left"></i> BACK</a>';
                  ...
                  $.ajax({
                    ...
                    success: function (data) {
                      var html = '';
                        ...
                        if(data.length == '0'){
                          html +=
                          '<td><a style="font-size: 16px;" href="javascript:void(0)" class="btn btn-success purchase"><i class="fa fa-cart-arrow-down"></i> POS Process Confirm</a</td>';
                        }
