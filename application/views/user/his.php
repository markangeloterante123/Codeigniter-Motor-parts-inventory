      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border"> 
                      ...
                      <a href="javascript:void(0)" class="btn btn-default pull-right back_file"><i class="fa fa-reply"></i> Back</a>
                      <input style="width: 30%;" type="text" name="search" id="search" class="form-control" placeholder="Search...">            
